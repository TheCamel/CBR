...
namespace CBR.Core.Helpers.Files.HTML
{
    ...
    internal class Helper
    {
        ...
        internal static bool ClosesOnNextElementStart(string currentElementName, string nextElementName)
        {
            ...
            {
                case "colgroup":
                    return _htmlElementsClosingColgroup.Contains(nextElementName) && Helper.IsBlockElement(nextElementName);
                case "dd":
                    return _htmlElementsClosingDD.Contains(nextElementName) && Helper.IsBlockElement(nextElementName);
                case "dt":
                    return _htmlElementsClosingDT.Contains(nextElementName) && Helper.IsBlockElement(nextElementName);
                case "li":
                    return _htmlElementsClosingLI.Contains(nextElementName);
                case "p":
                    return Helper.IsBlockElement(nextElementName);
                case "tbody":
